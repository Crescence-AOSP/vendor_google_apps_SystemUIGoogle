...
open class AmbientIndicationContainer(context: Context, attrs: AttributeSet) :
    ...
    fun updateColorScheme(
        ...
        if (smallIcon == null) {
            val fallbackColor =
                context.getColor(com.android.internal.R.color.materialColorSurfaceContainerHighest)
        ...
        val iconTargetColor =
            if (dynamicScheme != null) {
                ...
                context.getColor(com.android.internal.R.color.materialColorOnPrimaryContainer)
            }
