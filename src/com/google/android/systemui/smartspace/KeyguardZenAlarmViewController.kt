...
constructor(
    val context: Context,
    @Named(SmartspaceModule.DATE_SMARTSPACE_DATA_PLUGIN) val datePlugin: BcSmartspaceDataPlugin,
    ...
    init {
        context.resources.getDrawable(R.drawable.ic_access_alarms_big, null)?.let {
            alarmImage = it
        }
    }
