...
/**
 * Root component for Dagger injection used in Google source.
 */
@Singleton
...
public interface SysUIGoogleGlobalRootComponent extends GlobalRootComponent {
    ...
    /**
     * Builder for a {@link SysUIGoogleGlobalRootComponent}, which makes it a subcomponent of this class.
     */
    @Override
